...
public class URLs {
    public static String url =  "http://192.168.8.101/test2/RoomApi.php?apicall=getrooms";
    private static final String ROOT_URL = "http://192.168.8.101/Admin/Api.php?apicall=";
    ...
    public static final String ROOT_URL2 = "http://192.168.8.101/Admin/RoomApi.php?apicall=";
